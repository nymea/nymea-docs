    ...
    return (
      <SplashContainer>
        ...
        <div className="inner">
          ...
          <PromoSection>
            <Button href={docUrl('build/01.index.html')}>>Build nymea</Button>
            <Button href={docUrl('plugins/01.index.html')}>Write a plug-in</Button>
            <Button href={docUrl('clients/01.index.html')}>Write a client</Button>
          </PromoSection>
        </div>
      </SplashContainer>
    );
