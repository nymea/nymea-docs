...
* [Texas Instruments](https://www.ti.com/product/CC2652R)
    ...
    * CC2652 (P/R/RB) - recommended option (e.g. the [slae.sh](https://slae.sh) or [Sonoff ZigBee 3.0 USB](https://sonoff.tech/product/gateway-amd-sensors/sonoff-zigbee-3-0-usb-dongle-plus-p/)
    * CC253x
