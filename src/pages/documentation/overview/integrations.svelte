...
<p>nymea integrations are extensions to nymea enable a specific device or service, commonly referred to as "things". By default nymea ships a list of most commonly used integration but there a large list of supported integrations which can be installed depending on the needs of a certain nymea setup.</p>
