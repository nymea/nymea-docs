...
See also: `ParamList <#api-param-list>`__
...
See also: `ParamTypes <#api-param-types>`__
...
See also: `ActionType <#api-action-type>`__
...
See also: `BackupFile <#api-backup-file>`__
...
See also: `BrowserIcon <#api-browser-icon>`__, `MediaBrowserIcon <#api-media-browser-icon>`__
...
See also: `RepeatingOption <#api-repeating-option>`__
...
See also: `CalendarItem <#api-calendar-item>`__
...
See also: `ParamDescriptors <#api-param-descriptors>`__

.. _api-event-descriptors:
...
See also: `EventDescriptor <#api-event-descriptor>`__
...
See also: `EventType <#api-event-type>`__
...
See also: `IOConnection <#api-i-o-connection>`__

.. _api-integration-plugin:
...
See also: `IntegrationPlugin <#api-integration-plugin>`__
...
See also: `LogEntry <#api-log-entry>`__
...
See also: `LoggingCategoryType <#api-logging-category-type>`__, `LoggingLevel <#api-logging-level>`__

.. _api-modbus-rtu-master:
...
See also: `SerialPortDataBits <#api-serial-port-data-bits>`__, `SerialPortParity <#api-serial-port-parity>`__, `SerialPortStopBits <#api-serial-port-stop-bits>`__
...
See also: `Package <#api-package>`__
...
See also: `ValueOperator <#api-value-operator>`__

.. _api-param-descriptors:
...
See also: `ParamDescriptor <#api-param-descriptor>`__
...
See also: `BasicType <#api-basic-type>`__, `InputType <#api-input-type>`__, `Unit <#api-unit>`__
...
See also: `ParamType <#api-param-type>`__

.. _api-repeating-option:
...
See also: `RepeatingMode <#api-repeating-mode>`__
...
See also: `Repository <#api-repository>`__
...
See also: `EventDescriptors <#api-event-descriptors>`__, `RuleActions <#api-rule-actions>`__, `StateEvaluator <#api-state-evaluator>`__, `TimeDescriptor <#api-time-descriptor>`__
...
See also: `RuleActionParams <#api-rule-action-params>`__

.. _api-rule-action-param:
...
See also: `RuleActionParam <#api-rule-action-param>`__
...
See also: `RuleAction <#api-rule-action>`__

.. _api-rule-description:
...
See also: `SerialPort <#api-serial-port>`__

.. _api-server-configuration:
...
See also: `StateValueFilter <#api-state-value-filter>`__

.. _api-state-descriptor:
...
See also: `StateDescriptor <#api-state-descriptor>`__, `StateEvaluators <#api-state-evaluators>`__, `StateOperator <#api-state-operator>`__

.. _api-state-evaluators:
...
See also: `StateEvaluator <#api-state-evaluator>`__
...
See also: `BasicType <#api-basic-type>`__, `IOType <#api-i-o-type>`__, `Unit <#api-unit>`__
...
See also: `StateType <#api-state-type>`__
...
See also: `ParamList <#api-param-list>`__, `States <#api-states>`__, `ThingError <#api-thing-error>`__, `ThingSetupStatus <#api-thing-setup-status>`__
...
See also: `ActionTypes <#api-action-types>`__, `CreateMethods <#api-create-methods>`__, `DiscoveryType <#api-discovery-type>`__, `EventTypes <#api-event-types>`__, `ParamTypes <#api-param-types>`__, `SetupMethod <#api-setup-method>`__, `StateTypes <#api-state-types>`__
...
See also: `ThingClass <#api-thing-class>`__

.. _api-thing-descriptor:
...
See also: `ThingDescriptor <#api-thing-descriptor>`__
...
See also: `Thing <#api-thing>`__

.. _api-time-descriptor:
...
See also: `CalendarItems <#api-calendar-items>`__, `TimeEventItems <#api-time-event-items>`__

.. _api-time-event-item:
...
See also: `TimeEventItem <#api-time-event-item>`__
...
See also: `TokenInfo <#api-token-info>`__

.. _api-tunnel-proxy-server-configuration:
...
See also: `PermissionScopes <#api-permission-scopes>`__
...
See also: `UserInfo <#api-user-info>`__
...
See also: `Vendor <#api-vendor>`__

.. _api-web-server-configuration:
...
See also: `NetworkDeviceState <#api-network-device-state>`__

.. _api-wireless-access-point:
...
See also: `NetworkDeviceState <#api-network-device-state>`__, `WirelessAccessPoint <#api-wireless-access-point>`__, `WirelessCapabilities <#api-wireless-capabilities>`__, `WirelessMode <#api-wireless-mode>`__
...
See also: `ZWaveNetworkState <#api-z-wave-network-state>`__
...
See also: `ZWaveDeviceType <#api-z-wave-device-type>`__, `ZWaveNodeRole <#api-z-wave-node-role>`__, `ZWaveNodeType <#api-z-wave-node-type>`__
...
See also: `ZigbeeAdapter <#api-zigbee-adapter>`__

.. _api-zigbee-binding-table-record:
...
See also: `ZigbeeClusterDirection <#api-zigbee-cluster-direction>`__

.. _api-zigbee-neighbor-table-record:
...
See also: `ZigbeeNodeRelationship <#api-zigbee-node-relationship>`__
...
See also: `ZigbeeNetworkState <#api-zigbee-network-state>`__
...
See also: `ZigbeeBindingTableRecord <#api-zigbee-binding-table-record>`__, `ZigbeeNeighborTableRecord <#api-zigbee-neighbor-table-record>`__, `ZigbeeNodeEndpoint <#api-zigbee-node-endpoint>`__, `ZigbeeNodeState <#api-zigbee-node-state>`__, `ZigbeeNodeType <#api-zigbee-node-type>`__, `ZigbeeRoutingTableRecord <#api-zigbee-routing-table-record>`__

.. _api-zigbee-node-endpoint:
...
See also: `ZigbeeCluster <#api-zigbee-cluster>`__

.. _api-zigbee-routing-table-record:
...
See also: `ZigbeeNodeRouteStatus <#api-zigbee-node-route-status>`__
...
.. _api-wired-network-connection-type:
...
See also: `CreateMethod <#api-create-method>`__

.. _api-permission-scopes:
...
See also: `PermissionScope <#api-permission-scope>`__

.. _api-wireless-capabilities:
...
See also: `WirelessCapability <#api-wireless-capability>`__
...
.. _api-configuration-create-and-download-backup:
...
See also: `ConfigurationError <#api-configuration-error>`__

.. _api-configuration-create-backup:
...
.. _api-configuration-delete-backup-file:
...
.. _api-configuration-delete-mqtt-policy:
...
.. _api-configuration-delete-mqtt-server-configuration:
...
.. _api-configuration-delete-tcp-server-configuration:
...
.. _api-configuration-delete-tunnel-proxy-server-configuration:
...
.. _api-configuration-delete-web-server-configuration:
...
.. _api-configuration-delete-web-socket-server-configuration:
...
.. _api-configuration-download-backup-file:
...
.. _api-configuration-get-available-languages:
...
.. _api-configuration-get-backup-files:
...
.. _api-configuration-get-configurations:
...
See also: `ServerConfiguration <#api-server-configuration>`__, `TunnelProxyServerConfiguration <#api-tunnel-proxy-server-configuration>`__, `WebServerConfiguration <#api-web-server-configuration>`__

.. _api-configuration-get-mqtt-policies:
...
See also: `MqttPolicy <#api-mqtt-policy>`__

.. _api-configuration-get-mqtt-server-configurations:
...
See also: `ServerConfiguration <#api-server-configuration>`__

.. _api-configuration-get-time-zones:
...
.. _api-configuration-restore-backup-file:
...
.. _api-configuration-set-backup-configuration:
...
.. _api-configuration-set-debug-server-enabled:
...
.. _api-configuration-set-language:
...
.. _api-configuration-set-location:
...
.. _api-configuration-set-mqtt-policy:
...
See also: `ConfigurationError <#api-configuration-error>`__, `MqttPolicy <#api-mqtt-policy>`__

.. _api-configuration-set-mqtt-server-configuration:
...
See also: `ConfigurationError <#api-configuration-error>`__, `ServerConfiguration <#api-server-configuration>`__

.. _api-configuration-set-server-name:
...
.. _api-configuration-set-tcp-server-configuration:
...
.. _api-configuration-set-time-zone:
...
.. _api-configuration-set-tunnel-proxy-server-configuration:
...
See also: `ConfigurationError <#api-configuration-error>`__, `TunnelProxyServerConfiguration <#api-tunnel-proxy-server-configuration>`__

.. _api-configuration-set-web-server-configuration:
...
See also: `ConfigurationError <#api-configuration-error>`__, `WebServerConfiguration <#api-web-server-configuration>`__

.. _api-configuration-set-web-socket-server-configuration:
...
.. _api-configuration-upload-and-restore-backup:
...
.. _api-debug-get-logging-categories:
...
See also: `LoggingCategory <#api-logging-category>`__

.. _api-debug-set-logging-category-level:
...
See also: `DebugError <#api-debug-error>`__, `LoggingLevel <#api-logging-level>`__

.. _api-integrations-add-thing:
...
See also: `ParamList <#api-param-list>`__, `ThingError <#api-thing-error>`__

.. _api-integrations-browse-thing:
...
See also: `BrowserItem <#api-browser-item>`__, `ThingError <#api-thing-error>`__

.. _api-integrations-confirm-pairing:
...
See also: `ThingError <#api-thing-error>`__

.. _api-integrations-connect-i-o:
...
.. _api-integrations-disconnect-i-o:
...
.. _api-integrations-discover-things:
...
See also: `ParamList <#api-param-list>`__, `ThingDescriptors <#api-thing-descriptors>`__, `ThingError <#api-thing-error>`__

.. _api-integrations-edit-thing:
...
.. _api-integrations-execute-action:
...
.. _api-integrations-execute-browser-item:
...
.. _api-integrations-execute-browser-item-action:
...
.. _api-integrations-get-action-types:
...
See also: `ActionTypes <#api-action-types>`__

.. _api-integrations-get-browser-item:
...
.. _api-integrations-get-event-types:
...
See also: `EventTypes <#api-event-types>`__

.. _api-integrations-get-i-o-connections:
...
See also: `IOConnections <#api-i-o-connections>`__, `ThingError <#api-thing-error>`__

.. _api-integrations-get-plugin-configuration:
...
See also: `IntegrationPlugins <#api-integration-plugins>`__

.. _api-integrations-get-state-types:
...
See also: `StateTypes <#api-state-types>`__

.. _api-integrations-get-state-value:
...
.. _api-integrations-get-state-values:
...
See also: `States <#api-states>`__, `ThingError <#api-thing-error>`__

.. _api-integrations-get-thing-classes:
...
See also: `ThingClasses <#api-thing-classes>`__, `ThingError <#api-thing-error>`__

.. _api-integrations-get-things:
...
See also: `ThingError <#api-thing-error>`__, `Things <#api-things>`__

.. _api-integrations-get-vendors:
...
See also: `Vendors <#api-vendors>`__

.. _api-integrations-pair-thing:
...
See also: `ParamList <#api-param-list>`__, `SetupMethod <#api-setup-method>`__, `ThingError <#api-thing-error>`__

.. _api-integrations-reconfigure-thing:
...
.. _api-integrations-remove-thing:
...
.. _api-integrations-set-action-logging:
...
.. _api-integrations-set-event-logging:
...
.. _api-integrations-set-plugin-configuration:
...
.. _api-integrations-set-state-filter:
...
See also: `StateValueFilter <#api-state-value-filter>`__, `ThingError <#api-thing-error>`__

.. _api-integrations-set-state-logging:
...
.. _api-integrations-set-thing-settings:
...
.. _api-j-s-o-n-r-p-c-authenticate:
...
.. _api-j-s-o-n-r-p-c-create-user:
...
See also: `UserError <#api-user-error>`__

.. _api-j-s-o-n-r-p-c-hello:
...
See also: `CacheHash <#api-cache-hash>`__, `Experience <#api-experience>`__, `PermissionScopes <#api-permission-scopes>`__

.. _api-j-s-o-n-r-p-c-introspect:
...
.. _api-j-s-o-n-r-p-c-request-push-button-auth:
...
.. _api-j-s-o-n-r-p-c-set-notification-status:
...
See also: `LogEntries <#api-log-entries>`__, `SampleRate <#api-sample-rate>`__, `SortOrder <#api-sort-order>`__

.. _api-modbus-rtu-add-modbus-rtu-master:
...
See also: `ModbusRtuError <#api-modbus-rtu-error>`__, `SerialPortDataBits <#api-serial-port-data-bits>`__, `SerialPortParity <#api-serial-port-parity>`__, `SerialPortStopBits <#api-serial-port-stop-bits>`__

.. _api-modbus-rtu-get-modbus-rtu-masters:
...
See also: `ModbusRtuError <#api-modbus-rtu-error>`__, `ModbusRtuMaster <#api-modbus-rtu-master>`__

.. _api-modbus-rtu-get-serial-ports:
...
See also: `SerialPorts <#api-serial-ports>`__

.. _api-modbus-rtu-reconfigure-modbus-rtu-master:
...
.. _api-modbus-rtu-remove-modbus-rtu-master:
...
See also: `ModbusRtuError <#api-modbus-rtu-error>`__

.. _api-network-manager-connect-wifi-network:
...
See also: `NetworkManagerError <#api-network-manager-error>`__

.. _api-network-manager-create-wired-connection:
...
See also: `NetworkManagerError <#api-network-manager-error>`__, `WiredNetworkConnectionType <#api-wired-network-connection-type>`__

.. _api-network-manager-disconnect-interface:
...
.. _api-network-manager-enable-networking:
...
.. _api-network-manager-enable-wireless-networking:
...
.. _api-network-manager-get-network-devices:
...
See also: `NetworkManagerError <#api-network-manager-error>`__, `WiredNetworkDevice <#api-wired-network-device>`__, `WirelessNetworkDevice <#api-wireless-network-device>`__

.. _api-network-manager-get-network-status:
...
See also: `NetworkManagerError <#api-network-manager-error>`__, `NetworkManagerState <#api-network-manager-state>`__

.. _api-network-manager-get-wireless-access-points:
...
See also: `NetworkManagerError <#api-network-manager-error>`__, `WirelessAccessPoint <#api-wireless-access-point>`__

.. _api-network-manager-scan-wifi-networks:
...
.. _api-network-manager-start-access-point:
...
See also: `EventDescriptor <#api-event-descriptor>`__, `RuleAction <#api-rule-action>`__, `RuleError <#api-rule-error>`__, `StateEvaluator <#api-state-evaluator>`__, `TimeDescriptor <#api-time-descriptor>`__

.. _api-rules-disable-rule:
...
See also: `RuleError <#api-rule-error>`__

.. _api-rules-edit-rule:
...
See also: `EventDescriptor <#api-event-descriptor>`__, `Rule <#api-rule>`__, `RuleAction <#api-rule-action>`__, `RuleError <#api-rule-error>`__, `StateEvaluator <#api-state-evaluator>`__, `TimeDescriptor <#api-time-descriptor>`__

.. _api-rules-enable-rule:
...
.. _api-rules-execute-exit-actions:
...
See also: `Rule <#api-rule>`__, `RuleError <#api-rule-error>`__

.. _api-rules-get-rules:
...
See also: `RuleDescription <#api-rule-description>`__

.. _api-rules-remove-rule:
...
See also: `Script <#api-script>`__, `ScriptError <#api-script-error>`__

.. _api-scripts-edit-script:
...
See also: `ScriptError <#api-script-error>`__

.. _api-scripts-get-script-content:
...
See also: `Scripts <#api-scripts>`__

.. _api-scripts-remove-script:
...
See also: `UpdateType <#api-update-type>`__

.. _api-system-get-packages:
...
See also: `Packages <#api-packages>`__

.. _api-system-get-repositories:
...
See also: `Repositories <#api-repositories>`__

.. _api-system-get-system-info:
...
See also: `Tag <#api-tag>`__, `TagError <#api-tag-error>`__
...
See also: `TagError <#api-tag-error>`__, `Tags <#api-tags>`__

.. _api-tags-remove-tag:
...
.. _api-users-change-user-password:
...
See also: `PermissionScopes <#api-permission-scopes>`__, `UserError <#api-user-error>`__

.. _api-users-get-tokens:
...
See also: `TokenInfoList <#api-token-info-list>`__, `UserError <#api-user-error>`__

.. _api-users-get-user-info:
...
See also: `UserError <#api-user-error>`__, `UserInfo <#api-user-info>`__

.. _api-users-get-user-tokens:
...
See also: `UserInfoList <#api-user-info-list>`__

.. _api-users-remove-token:
...
See also: `ZWaveError <#api-z-wave-error>`__

.. _api-z-wave-add-node:
...
.. _api-z-wave-cancel-pending-operation:
...
.. _api-z-wave-factory-reset-network:
...
See also: `ZWaveNetwork <#api-z-wave-network>`__

.. _api-z-wave-get-nodes:
...
See also: `ZWaveError <#api-z-wave-error>`__, `ZWaveNode <#api-z-wave-node>`__

.. _api-z-wave-get-serial-ports:
...
.. _api-z-wave-is-z-wave-available:
...
.. _api-z-wave-remove-failed-node:
...
See also: `ZigbeeError <#api-zigbee-error>`__

.. _api-zigbee-create-binding:
...
.. _api-zigbee-factory-reset-network:
...
See also: `ZigbeeAdapters <#api-zigbee-adapters>`__

.. _api-zigbee-get-available-backends:
...
See also: `ZigbeeNetwork <#api-zigbee-network>`__

.. _api-zigbee-get-nodes:
...
See also: `ZigbeeError <#api-zigbee-error>`__, `ZigbeeNode <#api-zigbee-node>`__

.. _api-zigbee-refresh-bindings:
...
.. _api-zigbee-refresh-neighbor-tables:
...
.. _api-configuration-backup-configuration-changed:
...
.. _api-configuration-backup-files-changed:
...
.. _api-configuration-basic-configuration-changed:
...
.. _api-configuration-mqtt-policy-changed:
...
.. _api-configuration-mqtt-policy-removed:
...
.. _api-configuration-mqtt-server-configuration-changed:
...
.. _api-configuration-mqtt-server-configuration-removed:
...
.. _api-configuration-tcp-server-configuration-changed:
...
.. _api-configuration-tcp-server-configuration-removed:
...
.. _api-configuration-tunnel-proxy-server-configuration-changed:
...
See also: `TunnelProxyServerConfiguration <#api-tunnel-proxy-server-configuration>`__

.. _api-configuration-tunnel-proxy-server-configuration-removed:
...
.. _api-configuration-web-server-configuration-changed:
...
See also: `WebServerConfiguration <#api-web-server-configuration>`__

.. _api-configuration-web-server-configuration-removed:
...
.. _api-configuration-web-socket-server-configuration-changed:
...
.. _api-configuration-web-socket-server-configuration-removed:
...
.. _api-debug-logging-category-level-changed:
...
See also: `LoggingLevel <#api-logging-level>`__

.. _api-integrations-event-triggered:
...
See also: `Event <#api-event>`__

.. _api-integrations-i-o-connection-added:
...
.. _api-integrations-i-o-connection-removed:
...
.. _api-integrations-plugin-configuration-changed:
...
.. _api-integrations-state-changed:
...
.. _api-integrations-thing-changed:
...
.. _api-integrations-thing-removed:
...
.. _api-integrations-thing-setting-changed:
...
.. _api-j-s-o-n-r-p-c-push-button-auth-finished:
...
.. _api-modbus-rtu-modbus-rtu-master-added:
...
See also: `ModbusRtuMaster <#api-modbus-rtu-master>`__

.. _api-modbus-rtu-modbus-rtu-master-changed:
...
.. _api-modbus-rtu-modbus-rtu-master-removed:
...
.. _api-modbus-rtu-serial-port-added:
...
.. _api-modbus-rtu-serial-port-removed:
...
.. _api-network-manager-network-status-changed:
...
See also: `NetworkManagerState <#api-network-manager-state>`__

.. _api-network-manager-wired-network-device-added:
...
See also: `WiredNetworkDevice <#api-wired-network-device>`__

.. _api-network-manager-wired-network-device-changed:
...
.. _api-network-manager-wired-network-device-removed:
...
.. _api-network-manager-wireless-network-device-added:
...
See also: `WirelessNetworkDevice <#api-wireless-network-device>`__

.. _api-network-manager-wireless-network-device-changed:
...
.. _api-network-manager-wireless-network-device-removed:
...
.. _api-rules-rule-active-changed:
...
.. _api-rules-rule-configuration-changed:
...
.. _api-scripts-script-content-changed:
...
.. _api-scripts-script-log-message:
...
See also: `ScriptMessageType <#api-script-message-type>`__

.. _api-scripts-script-removed:
...
.. _api-system-capabilities-changed:
...
.. _api-system-repository-changed:
...
.. _api-system-repository-removed:
...
.. _api-system-time-configuration-changed:
...
.. _api-system-update-status-changed:
...
.. _api-transfers-download-available:
...
.. _api-users-push-button-auth-finished:
...
See also: `ZWaveNode <#api-z-wave-node>`__

.. _api-z-wave-node-changed:
...
See also: `ZigbeeNode <#api-zigbee-node>`__

.. _api-zigbee-node-changed:
