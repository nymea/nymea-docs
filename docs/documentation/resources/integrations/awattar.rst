...
This integration allows to receive the current energy market price from `aWATTar GmbH <https://www.awattar.com/>`__. aWattar is currently available in Austria and Germany.
...
.. image:: https://raw.githubusercontent.com/guh/nymea-plugins/master/awattar/docs/images/awattar-graph.png "aWATTar graph"
   :alt: aWATTar graph
...
* `aWATTar Austria <https://www.awattar.com>`__

* `aWATTar Germany <https://www.awattar.de>`__
