...
The `SmartDongle <https://solar.huawei.com/-/media/Solar/attachment/pdf/apac/datasheet/SmartDongle-WLAN-FE.pdf>`__ can be used to communicate 
...
* Use the official FusonSolar App to enable Modbus TCP access for the Dongle (full access). You can find more informations `here <https://forum.huawei.com/enterprise/en/modbus-tcp-guide/thread/789585-100027?page=1#comments-area>`__.


You can also contact the `official Huawei support <mailto:eu_inverter_support@huawei.com>`__ in order to get the update files and instructions, or get it from `here <https://support.huawei.com/enterprise/en/digital-power/sdongle-pid-23826585/software>`__.
