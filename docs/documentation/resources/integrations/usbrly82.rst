...
Information about the USB relay hardware can be found `here <https://www.robot-electronics.co.uk/usb-rly82.html>`__.
The datasheet can be downloaded from `here <https://www.robot-electronics.co.uk/files/usb-rly82.pdf>`__
