...
Once the network connection has been established, use the original `PANTABOX app <https://www.pantabox.de/Informationen/App/>`__ in order to enable the ``Modbus TCP`` profile.


.. image:: https://raw.githubusercontent.com/nymea/nymea-plugins-modbus/master/inro/docs/inro-app-profiles.jpg
   :alt: Loading profiles



.. image:: https://raw.githubusercontent.com/nymea/nymea-plugins-modbus/master/inro/docs/inro-app-modbus-active.jpg
   :alt: Modbus TCP profile
