...
**Categories:** switch, socket, diy

**Technologies:** network, mqtt
...
See the `Tasmota wiki <https://tasmota.github.io/docs/#/Home>`__ for a list of all supported devices and instructions on how to
