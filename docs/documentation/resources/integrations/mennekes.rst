...
It is highly recommended to update the wallbox to the latest firmware which can be downloaded from `here <https://www.chargeupyourday.de/services/software-updates/>`__.
