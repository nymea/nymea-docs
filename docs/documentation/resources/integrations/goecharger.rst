...
The documentation of the API V1 can be found `here <https://github.com/goecharger/go-eCharger-API-v1>`__.
The documentation of the API v2 can be found `here <https://github.com/goecharger/go-eCharger-API-v2>`__.
