.. _doc-developers-integrations-interfaces:
...
the ui to be used for this :doc:`thing class <thing-class>`. For example, having a plugin that can control a dimmable light would likely have a
...
The complete list of available interfaces with their required states, actions, and events is
available in the :doc:`interface reference </documentation/resources/interfaces>`.
